...
![モデル図](https://github.com/h-kojima/ocp3u3/blob/master/images/openshift-deployement-model.png)
...
Step4. OpenShiftインストール用に用意されたAnsibleインベントリファイルを[こちら](https://github.com/h-kojima/ocp3u3/blob/master/ansible/sample-ansible-hosts)からダウンロードします。インベントリファイルで指定しているDNSワイルドカードについては、[こちらのファイル](https://github.com/h-kojima/ocp3u3/tree/master/bind-chroot)を参考に設定して下さい。
